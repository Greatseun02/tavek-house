    ...
    <section id='home' className='relative'>
        ...
        <div className='bg-primaryWhite herosection'>
            <div className=' container px-sm mx-auto text-center pt-16 xl:px-xl '>
                <p className='text-[48px] font-medium syne leading-[50px] tracking-[-0.8px] xl:text-[72px] xl:w-[60%] mx-auto xl:leading-[80px]'>A different kind of workspace</p>
                <div className='grid grid-cols-2 gap-1 mt-10 w-fit mx-auto '>
                    <Button onClick={handleClick} style={"font-[700] bg-primaryBlue text-lg max-w-[200px] tochange"} text={"Get Started"}/>
                    <Button onClick={handleTourClick} text={"Book a tour"} style={"font-[700] tochange bg-primaryBlack max-w-[200px] "}/>
                </div>
